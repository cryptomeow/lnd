...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/cryptomeow/lnd/chainntnfs)
...
```bash
$ go get -u github.com/cryptomeow/lnd/chainntnfs
```
