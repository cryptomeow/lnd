...
[In this PR](https://github.com/cryptomeow/lnd/pull/773) we added a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/cryptomeow/lnd/aezeed
...
PASS
ok      github.com/cryptomeow/lnd/aezeed  4.168s
```
